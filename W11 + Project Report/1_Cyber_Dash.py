...
from services. import security_incident_manager


incident_manager = SecurityIncidentManager(db_connector=connect_database)
...
try:
    # 💥 CHANGE 1: Use the manager instance method
...
# ==================== VISUALIZATIONS ====================
try:
    # 💥 CHANGE 2: Get incidents as a list of objects, then convert to DataFrame
    incidents_list = incident_manager.get_all_incidents()
    df = pd.DataFrame([incident.__dict__ for incident in incidents_list])

    # Original dashboard code assumed 'df' was available here:
    if len(df) > 0:
        filtered_df = df[
        ...
        with st.form("new_incident_form"):
            ...
            if submitted:
                if incident_type and incident_description:
                    try:
                        # 💥 CHANGE 3: Use the manager instance method
                        new_id = incident_manager.insert_incident(  # Assuming you added insert_incident to manager
            ...
            if selected_incident:
                ...
                with col1:
                    ...
                    with st.form(f"update_form_{selected_id}"):
                        ...
                        if st.form_submit_button("💾 Update"):
                            try:
                                # 💥 CHANGE 4: Use the manager instance method
                                if incident_manager.update_incident_status(
                ...
                with col2:
                    ...
                    if st.button(
                        ...
                        try:
                            # 💥 CHANGE 5: Use the manager instance method
                            if incident_manager.delete_incident(selected_id):
